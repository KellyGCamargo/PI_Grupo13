...
const formularioController = {
    viewForm: (req, res) => {
        return res.render('formulario/acidentesPessoaisPlus');
    },
    ...
    sendForm: (req, res, next) => {
        ...
        upload(req, res, function (err) {
            if (err) {
                ...
                let mailOption = {
                    from: "Atendimento <atendimento@klmcorretoradeseguros.com.br>",
                    to: "atendimento@klmcorretoradeseguros.com.br",
                    replyTo: obj.inputEmailTitular,
        ...
        <div style="margin: 20px;">
            ...
            <table style='width: 100%;' border="3">
                ...
                <tr>
                    ...
                    <td colspan="1">${obj.inputCpfBeneficiario1}</td>
                    <td colspan="1">${obj.inputParentescoBeneficiario1}</td>
                ...
                <tr>
                    ...
                    <td colspan="1">${obj.inputDnBeneficiario1}</td>
                    <td colspan="1">${obj.inputCpfBeneficiario1}</td>
                    <td colspan="1">${obj.inputParentescoBeneficiario2}</td>
                    <td colspan="1">${obj.inputDistribuicaoBeneficiario1}</td>
                </tr>
                <tr>
                    <td colspan="2">${obj.inputNomeBeneficiario1}</td>
                    <td colspan="1">${obj.inputDnBeneficiario1}</td>
                    <td colspan="1">${obj.inputCpfBeneficiario1}</td>
                    <td colspan="1">${obj.inputParentescoBeneficiario3}</td>
                    <td colspan="1">${obj.inputDistribuicaoBeneficiario1}</td>
                </tr>
                <tr>
                    <td colspan="2">${obj.inputNomeBeneficiario1}</td>
                    <td colspan="1">${obj.inputDnBeneficiario1}</td>
                    <td colspan="1">${obj.inputCpfBeneficiario1}</td>
                    <td colspan="1">${obj.inputParentescoBeneficiario4}</td>
                    <td colspan="1">${obj.inputDistribuicaoBeneficiario1}</td>
                </tr>
